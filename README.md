...
1. Searching
    - Our search parameters:
        ...
        - Search types change depending on what you're looking at. For instance, if you're on the *artist* page, you cannot search by *song name*
    - Our sort parameters:
        - Sort by `popularity`, `name`, `release date`, and `album name`
        - Sort types change depending on what you're looking at. For instance, if you're on the *artist* page, you cannot sort by *album name*
2. Movie List Page
